...
use crate::utilities::order::OrderOperatorByKeyCustom;
...
where   Mapping:                               ViewRowAscend + ViewColDescend + IndicesAndCoefficients, // we require ViewColDescend for the function `new(..)`, but not for the `Umatch` struct itself.
        ...
        HitMerge<Peekable<Scale<<Mapping::ViewMajorAscend as IntoIterator>::IntoIter, Mapping::ColIndex, RingOperator, Mapping::Coefficient>>, OrderOperatorByKeyCustom< Mapping::ColIndex, Mapping::Coefficient, Mapping::EntryMajor, OrderOperatorKeyMin>>: Clone, // !!!! remove this                 
{
