...
use crate::utilities::order::{OrderOperatorByKeyCustom, JudgePartialOrder};
    ...
    fn umatch< Other, RingOperator, OrderOperatorRowIndex, OrderOperatorColIndex, IterRowIndex >(
        ...
        Umatch 
            < 
                Self, 
                RingOperator, 
                OrderOperatorByKeyCustom< Self::ColIndex, Self::Coefficient, Self::EntryMajor, OrderOperatorColIndex, >,  // recall that entries in the major views have minor keys
                OrderOperatorByKeyCustom< Self::RowIndex, Self::Coefficient, Self::EntryMinor, OrderOperatorRowIndex, >, // recall that entries in the minor views have major keys
            >  
