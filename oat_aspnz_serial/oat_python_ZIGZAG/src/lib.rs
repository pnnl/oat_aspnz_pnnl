...
use zigzag::{barcode_for_union_zigzag_of_hypergraphs_z2_coefficients, homology_decomposition_for_union_zigzag_of_hypergraphs_z2_coefficients, homology_decomposition_for_union_zigzag_of_hypergraphs_z2_coefficients_WITH_SPANS, homology_decomposition_for_union_zigzag_of_hypergraphs_z2_coefficients_WITH_SPANS_barcode_only};
...
fn oat_python(_py: Python, m: &PyModule) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(barcode_for_union_zigzag_of_hypergraphs_z2_coefficients, m)?)?;
    m.add_function(wrap_pyfunction!(homology_decomposition_for_union_zigzag_of_hypergraphs_z2_coefficients, m)?)?;
    m.add_function(wrap_pyfunction!(homology_decomposition_for_union_zigzag_of_hypergraphs_z2_coefficients_WITH_SPANS, m)?)?; 
    m.add_function(wrap_pyfunction!(homology_decomposition_for_union_zigzag_of_hypergraphs_z2_coefficients_WITH_SPANS_barcode_only, m)?)?;            
    Ok(())
}
