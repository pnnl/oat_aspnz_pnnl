...
use crate::utilities::order::{JudgePartialOrder, OrderOperatorByKey, OrderOperatorByKeyCustom, ReverseOrder};
...
pub fn get_codomain_comb_inv_off_diag_pivot_block< Mapping, RingOperator, IterRowIndex, OrderOperatorRowEntries, > // OrderOperatorColEntries >
    ...
    where   Mapping:                 ViewRowAscend + IndicesAndCoefficients,
            ...
            HitMerge<Peekable<Scale<<Mapping::ViewMajorAscend as IntoIterator>::IntoIter, Mapping::ColIndex, RingOperator, Mapping::Coefficient>>, OrderOperatorByKeyCustom< Mapping::ColIndex, Mapping::Coefficient, Mapping::EntryMajor, OrderOperatorRowEntries>>: Clone // !!!! remove this

{
    ...
    let order_operator_for_entries_with_minor_keys = OrderOperatorByKeyCustom::new( order_operator_for_keymin );
    // let order_operator_for_entries_with_major_keys = OrderOperatorByKeyCustom::new( order_operator_for_keymaj );
