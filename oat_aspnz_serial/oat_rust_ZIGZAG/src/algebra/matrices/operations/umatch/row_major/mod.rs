...
impl < Mapping, RingOperator, OrderOperatorRowIndex, OrderOperatorColIndex, >  
    ...
    Umatch 
        < 
            Mapping, 
            RingOperator, 
            OrderOperatorByKeyCustom< Mapping::ColIndex, Mapping::Coefficient, Mapping::EntryMajor, OrderOperatorColIndex, >,  // recall that entries in the major views have minor keys
            OrderOperatorByKeyCustom< Mapping::RowIndex, Mapping::Coefficient, Mapping::EntryMinor, OrderOperatorRowIndex, >, // recall that entries in the minor views have major keys
        >  
        ...
        // OrderOperatorByKey<usize, Mapping::Coefficient, (usize, Mapping::Coefficient)>: JudgePartialOrder< (usize, Mapping::Coefficient)>
{
    ...
    pub fn factor_with_clearing
        ...
        Umatch< 
                Mapping, 
                RingOperator, 
                OrderOperatorByKeyCustom< Mapping::ColIndex, Mapping::Coefficient, Mapping::EntryMajor, OrderOperatorColIndex >, 
                OrderOperatorByKeyCustom< Mapping::RowIndex, Mapping::Coefficient, Mapping::EntryMinor, OrderOperatorRowIndex >, 
            > 
    ...
    where   Mapping:                           ViewRowAscend + IndicesAndCoefficients< ColIndex=KeyBoth, RowIndex=KeyBoth >, 
            ...
            OrderOperatorColIndex:                    Clone + JudgePartialOrder <  Mapping::ColIndex >, // !!! remove clone
            OrderOperatorRowIndex:                    Clone + JudgePartialOrder <  Mapping::RowIndex >,
            // HitMerge<Peekable<Scale<<Mapping::ViewMajorAscend as IntoIterator>::IntoIter, Mapping::ColIndex, RingOperator, Mapping::Coefficient>>, OrderOperatorByKeyCustom< Mapping::ColIndex, Mapping::Coefficient, Mapping::EntryMajor, OrderOperatorColIndex>>: Clone // !!!! remove this        
...
// }
    ...
    pub fn new_custom_order
        ...
        Umatch< 
                ...
                RingOperator, 
                OrderOperatorByKeyCustom< Mapping::ColIndex, Mapping::Coefficient, Mapping::EntryMajor, OrderOperatorColIndex >, 
                OrderOperatorByKeyCustom< Mapping::RowIndex, Mapping::Coefficient, EntryMinor, OrderOperatorRowIndex >, 
            > 
...
mod unit_tests {
    ...
    fn test_umatchrowmajor_comprehensive_small() {
        ...
        let umatch: Umatch<
                        ...
                        OrderOperatorByKeyCustom<usize, usize, (usize, usize), OrderOperatorAuto>, 
                        OrderOperatorByKeyCustom<usize, usize, (usize, usize), OrderOperatorAuto>,
                    > 
            =   Umatch::factor(
                    mapping, 
