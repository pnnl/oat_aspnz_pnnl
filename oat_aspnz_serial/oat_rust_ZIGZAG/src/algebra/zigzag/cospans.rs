...

{
    ...
    for factored_bookend_boundary_matrix in vec![ & factored_boundary_matrix_a, & factored_boundary_matrix_b ] {
        ...
        for harmonic_basis_vector_in_bookend        in    factored_bookend_boundary_matrix.basis_harmonic() {
            ...
            let mut harmonic_basis_vector_in_bookend    =   harmonic_basis_vector_in_bookend.collect::<Vec<_>>();
    ...
    Cospan{
        ...
        right_morphism,
        left_basis,
        center_basis:       factored_boundary_matrix_u.basis_homology_vec_of_vec(),
        right_basis,
    }
